...
public class SavedPersonController {
    ...
    public SavedPerson updatePerson(@PathVariable String documento, @Valid @RequestBody SavedPerson person) {
        SavedPerson updated = repository.update(documento, person);
        if (updated == null) {
